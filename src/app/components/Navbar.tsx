  ...
  return (
    <nav className="relative bg-accent-200 shadow-md z-40">
      <div className="container w-full  flex items-center justify-between p-4 bg-accent-200 shadow-md xl:shadow-none z-20">
        {/* Logo */}
        <a href="/" className="flex items-center gap-2 px-4 py-1 bg-white bg-opacity-20 hover:bg-opacity-10 transition-all duration-200 rounded-full">
          <img src={logo2.src} alt="Logo" className="h-8" />
        </a>
